...
?>
		...
		<div id="about">		
			<h3>About.</h3>			
			<p class="lead">I am a Digital Designer and Creative Director living in Sydney, Australia. With a passion for problem solving &mdash; I enjoy varied, challenging digital work.</p>
			...
			<p>I am an excellent communicator with a passion for creativity and technical innovation. Well-versed in running a project from concept through to completion &mdash; I not only have experience in design, but a proven track record of building and leading highly successful creative teams &mdash; most recently as the UX Director for <a href="http://campaignmonitor.com">Campaign Monitor</a>.</p>
			
			<p>In pursuit of user-driven design, have also founded and managed several profitable products, most significantly as the Founder of <a href="https://prevue.it/">Prevue</a> &mdash; a product built and run solely by myself, and used by over 25,000 agencies to share design concepts with clients. In addition to unparalleled customer interaction, the experience of running a business has taught me how to continually push the boundaries of a project whilst also working within limited technical scope and harsh financial constraints.</p>
