...
?>
	...
	<div class="fullImage">
		<img src="../_images/skype/skype.jpg" />
	</div>
	...
	<div class="container">	
		<div class="project">
			...
			<div class="image close"><img class="lazyload" data-sizes="auto" data-src="../_images/skype/main_icons.png" width="100%" /></div>
	...
	<div class="container">
		<div class="project">
			...
			<div class="image"><img class="lazyload" data-sizes="auto" data-src="../_images/skype/misc.png" width="100%" /></div>
		</div>
		<dl class="outro">
			<div class="col left">
				<dt>Position</dt>
